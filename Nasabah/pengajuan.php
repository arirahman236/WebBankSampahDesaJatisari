        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php
                    include '../config.php';
                    $id_nas= $_SESSION['id_nasabah'];
                    $rekening  = mysqli_query($db, "select * from tabungan where id_nasabah='$id_nas'");
                            ...
                            <div class="table-responsive">
                                <table class="shadow table table-bordered" cellspacing="0">
                                    <form name="pengajuan" id="pengajuan">
                                        ...
                                        <input type="hidden" name="id_nasabah" id="id_nasabah"value="<?php echo $_SESSION['id_nasabah'] ?>"  />
                                        <tr>
